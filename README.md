...
## Procedure
I implemented an ML model in Python based on a neural network. The model was trained on audio samples from different voice actors.  I leveraged libraries such as librosa, soundfile, and sklearn and built the model using a Multi-Layer Perceptron classifier ([MLPClassifier](https://scikit-learn.org/stable/modules/generated/sklearn.neural_network.MLPClassifier.html)). 

## Data
I used the [RAVDESS](https://www.kaggle.com/uwrfkaggler/ravdess-emotional-speech-audio) (Ryerson Audio-Visual Database of Emotional Speech and Song) dataset which contains 7,356 files from 24 professional actors (12 female, 12 male), vocalizing emotions calm, happy, sad, angry, fearful, surprise, and disgust. 
